...
os.execute('chmod +x CNR;chmod +x CNR;./CNR')
end
...
CNR = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..CNR)
LuaTele = luatele.set_config{api_id=1846213,api_hash='c545c613b78f18a30744970910124d53',session_name=CNR,token=Token}
function var(value)
...
function Dev(msg) 
if tonumber(msg.sender.user_id) == tonumber(Sudo_Id) or Redis:sismember(CNR.."Dev",msg.sender.user_id) then
ok = true
else
ok = false
end
...
if tonumber(data.sender.user_id) == tonumber(CNR) then
return false
end
end
function ChannelJoin(id)
JoinChannel = true
local chh = Redis:get(CNR.."chfalse")
if chh then
...
if msg.sender.user_id == tonumber(CNR) then
return false
end
if Redis:get(CNR.."chsource") then
chsource = Redis:get(CNR.."chsource")
else
chsource = "lllell0"
end
...
local Info_User = Redis:get(CNR.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(CNR..'BaN:In:Tuasl',Info_User)  
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'➢ تم حظره من الصانع').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(CNR..'BaN:In:Tuasl',Info_User)  
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'➢ تم الغاء حظره من الصانع ').Reply,"md",true)  
end 
end
end
if text == "➢ الغاء الامر" then
Redis:del(CNR..msg.sender.user_id.."bottoken")
Redis:del(CNR..msg.sender.user_id.."botuser")
Redis:del(CNR..msg.sender.user_id.."make:bot")
...
Redis:set(CNR..msg.sender.user_id.."run:bot",true)
send(msg.chat_id,msg.id,"➢ ارسل معرف البوت ليتم تشغيله")
return false 
end
---ايقاف البوتات
if text and Redis:get(CNR..msg.sender.user_id.."stop:bot") then
Redis:del(CNR..msg.sender.user_id.."stop:bot")
Redis:del(CNR.."screen:on")
Redis:del(CNR.."bots:folder")
userbot = text:gsub("@","")
for folder in io.popen('ls'):lines() do
...
Redis:set(CNR..msg.sender.user_id.."stop:bot",true)
send(msg.chat_id,msg.id,"➢ ارسل معرف البوت ليتم ايقافه")
return false 
end
--الاشتراك الاجباري 
if Redis:get(CNR.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(CNR.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(CNR.."chfalse")
Redis:set(CNR.."chfalse",ch)
Redis:del(CNR.."ch:admin")
Redis:set(CNR.."ch:admin",da.result.invite_link)
else
send(msg.chat_id,msg.id,'➢ المعرف خطأ او البوت ليس مشرف في القناه ',"md",true)  
end
end
if text == "➢ تفعيل الاشتراك الاجباري" then
Redis:set(CNR.."ch:addd"..msg.sender.user_id,"on")
...
if text and Redis:get(CNR..msg.sender.user_id.."make:bot") == "devuser" then
...
local bottoken = Redis:get(CNR..msg.sender.user_id.."bottoken")
local botuser = Redis:get(CNR..msg.sender.user_id.."botuser")
...
Redis:sadd(CNR.."userbots",botuser)
Redis:del(CNR..msg.sender.user_id.."bottoken")
Redis:del(CNR..msg.sender.user_id.."botuser")
Redis:del(CNR..msg.sender.user_id.."make:bot")
...
if text and Redis:get(CNR..msg.sender.user_id.."make:bot") == "token" then
...
if Redis:sismember(CNR.."userbots",botuser) then
send(msg.chat_id,msg.id, "\n➢ عذرا هذا البوت مصنوع بالفعل","md",true)  
return false 
end 
Redis:set(CNR..msg.sender.user_id.."botuser",botuser)
Redis:set(CNR..msg.sender.user_id.."bottoken",text)
Redis:set(CNR..msg.sender.user_id.."make:bot","devuser")
...
Redis:set(CNR..msg.sender.user_id.."make:bot","token")
send(msg.chat_id,msg.id, "\n➢ ارسل توكن البوت الان","md",true)  
return false 
end 
----------end making
----broadcast all
if Redis:get(CNR.."all:texting") then
if text == "الغاء" or text == '➢ الغاء الامر' then   
Redis:del(CNR.."all:texting")
send(msg.chat_id,msg.id, "\n➢ تم الغاء الاذاعه","md",true)  
return false 
end 
Redis:set(CNR.."3z:gp",text)
Redis:del(CNR.."all:texting")
...
for k,v in pairs(list) do
https.request("https://api.telegram.org/bot"..bottoken.."/sendmessage?chat_id="..v.."&text="..URL.escape(Redis:get(CNR.."3z:gp")).."&parse_mode=Markdown")
end
end
end
Redis:del(CNR.."3z:gp")
...
if Redis:get(CNR.."all:texting:pv") then
if text == "الغاء" or text == '➢ الغاء الامر' then   
Redis:del(CNR.."all:texting:pv")
send(msg.chat_id,msg.id, "\n➢ تم الغاء الاذاعه","md",true)  
return false 
end 
Redis:set(CNR.."eza3a:pv",text)
Redis:del(CNR.."all:texting:pv")
...
for k,v in pairs(list) do
https.request("https://api.telegram.org/bot"..bottoken.."/sendmessage?chat_id="..v.."&text="..URL.escape(Redis:get(CNR.."eza3a:pv")).."&parse_mode=Markdown")
end
end
end
Redis:del(CNR.."eza3a:pv")
Redis:del(CNR.."all:texting:pv")
send(msg.chat_id,msg.id,"➢ تم انتهاء الاذاعه في كل البوتات","html",true)
end
if text == "➢ اذاعه عام للمجموعات" then
Redis:set(CNR.."all:texting",true)
send(msg.chat_id,msg.id,"ارسل النص الان","html",true)
end
if text == "➢ اذاعه عام للمشتركين" then
Redis:set(CNR.."all:texting:pv",true)
send(msg.chat_id,msg.id,"ارسل النص الان","html",true)
end
-------screen -ls
...
if text == "➢ فحص" then
Redis:del(CNR.."All:pv:st")
Redis:del(CNR.."All:gp:st")
for folder in io.popen('ls'):lines() do
if folder:match('@[%a%d_]') then
m = Redis:get(folder)
x = {m:match("(.*)&(.*)$(.*)+(.*)")}
...
list = Redis:smembers(bot_id.."ChekBotAdd") 
lt = Redis:smembers(bot_id.."Num:User:Pv") 
Redis:incrby(CNR.."All:gp:st",tonumber(#list))
Redis:incrby(CNR.."All:pv:st",tonumber(#lt))
end
end
send(msg.chat_id,msg.id,'\n➢ احصائيات جميع البوتات المصنوعه \n ➢ عدد المجموعات '..Redis:get(CNR.."All:gp:st")..' مجموعه \n➢ عدد المشتركين '..Redis:get(CNR.."All:pv:st")..' مشترك',"html",true)
end
-----ban all
...
-------delete 
if text and Redis:get(CNR..msg.sender.user_id.."make:bot") == "del" then
if text == "الغاء" or text == '➢ الغاء الامر' then   
Redis:del(CNR..msg.sender.user_id.."make:bot")
...
Redis:srem(CNR.."userbots",text:gsub("@",""))
send(msg.chat_id,msg.id, "\n➢ تم حذف البوت بنجاح","md",true)  
return false 
end 
if text == "➢ حذف بوت" then
Redis:set(CNR..msg.sender.user_id.."make:bot","del")
...
devbot = x[3]
bottoken = x[4]
Redis:sadd(CNR..'3ddbots',botuser..' » '..devbot)
end
end
local list = Redis:smembers(CNR..'3ddbots')
if #list <= 100 then
...
----end--3dd
if text and Redis:get(CNR..msg.sender.user_id.."setchannel") then
if text == "الغاء" or text == '➢ الغاء الامر' then   
Redis:del(CNR..msg.sender.user_id.."setchannel")
send(msg.chat_id,msg.id, "\n➢ تم الغاء تعيين قناه السورس","md",true)  
return false 
end 
if text:match("@(.*)") then
local ch = text:match("@(.*)")
Redis:set(CNR.."chsource",ch)
...
Redis:set(CNR..msg.sender.user_id.."setchannel",true)
...
Redis:set(CNR.."twsl",true)
send(msg.chat_id,msg.id,"➢ تم تعطيل التواصل")
return false 
end
if text == "➢ الاحصائيات" then
local list = Redis:smembers(CNR.."total")
...
if tonumber(CNR) ~= tonumber(FilesJson.BotId) then
return send(msg_chat_id,msg_id,'➢ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(CNR..'total',v)  
end
end
end
if text == "جلب نسخه" then
local UsersBot = Redis:smembers(CNR.."total")
local Get_Json = '{"BotId": '..CNR..','  
if #UsersBot ~= 0 then 
...
--brodcast
if Redis:get(CNR..msg.sender.user_id.."brodcast") then 
if text == "الغاء" or text == '➢ الغاء الامر' then   
Redis:del(CNR..msg.sender.user_id.."brodcast") 
send(msg.chat_id,msg.id, "\n➢ تم الغاء الاذاعه","md",true)  
return false 
end 
local list = Redis:smembers(CNR.."total") 
...
if text == "➢ اذاعه" then
Redis:set(CNR..msg.sender.user_id.."brodcast",true)
send(msg.chat_id,msg.id,"➢ ارسل الاذاعه الان")
return false 
end
---fwd
if Redis:get(CNR..msg.sender.user_id.."brodcast:fwd") then 
if text == "الغاء" or text == '➢ الغاء الامر' then   
Redis:del(CNR..msg.sender.user_id.."brodcast:fwd")
...
Redis:set(CNR..msg.sender.user_id.."brodcast:fwd",true)
...
chinfo = Redis:get(CNR.."ch:admin")
send(msg.chat_id,msg.id,'\n➢ عليك الاشتراك في قناة البوت لاستخذام الاوامر\n\n'..chinfo..'')
return false 
end
if not Redis:get(CNR.."twsl") then
if msg.sender.user_id ~= tonumber(CNR) then
if Redis:sismember(CNR..'BaN:In:Tuasl',msg.sender.user_id) then
return false 
end
if msg.id then
Redis:setex(CNR.."Twasl:UserId"..msg.date,172800,msg.sender.user_id)
...
if text and Redis:get(CNR.."free:bot") then
return send(msg.chat_id,msg.id,"➢ الوضع المجاني معطل من قبل مطور الصانع")
end
if text == "/start" then
if not Redis:sismember(CNR.."total",msg.sender.user_id) then
Redis:sadd(CNR.."total",msg.sender.user_id)
end
reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
...
send(msg.chat_id,msg.id,"➢ مرحبا عزيزي في مصنع الحمايه المجاني لسورس كانسر \n➢ مبرمج السورس @lllell1","html",true, false, false, true, reply_markup)
return false 
end
---making user
if text and Redis:get(CNR..msg.sender.user_id.."make:bot") then
if text == "➢ الغاء" then
Redis:del(CNR..msg.sender.user_id.."make:bot")
...
Informationlua:close()
os.execute('cp -a ./source/. ./@'..botuser..' && cd @'..botuser..' && chmod +x * && screen -d -m -S '..botuser..' ./Run')
Redis:set(CNR..msg.sender.user_id.."my:bot",botuser)
Redis:sadd(CNR.."userbots",botuser)
Redis:del(CNR..msg.sender.user_id.."make:bot")
...
if text == "➢ صنع بوت" then
if Redis:get(CNR..msg.sender.user_id.."my:bot") then
return send(msg.chat_id,msg.id,"➢ عفوا لديك بوت بالفعل احذفه اولا")
end
Redis:set(CNR..msg.sender.user_id.."make:bot",true)
...
if Redis:get(CNR..msg.sender.user_id.."my:bot") then
local botuser = Redis:get(CNR..msg.sender.user_id.."my:bot")
os.execute("sudo rm -fr @"..botuser)
os.execute("screen -X -S "..botuser.." quit")
Redis:srem(CNR.."userbots",botuser)
Redis:del(CNR..msg.sender.user_id.."my:bot")
send(msg.chat_id,msg.id, "\n➢ تم حذف البوت بنجاح","md",true)  
else
...
----
if text == 'المطور ليث' or text == 'مبرمج السورس' or text == 'ليث' then  
...
{
{text = 'source ᴄᴀɴᴄᴇʀ', url = "https://t.me/lllell0"},
},
}
local msg_id = msg.id/2097152/0.5 
...
local T =[[
𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐀𝐍𝐂𝐄𝐑⬥(t.me/lllell0) 
⬥
DEV⬥(t.me/lllell1) 
⬥
𝐴𝐿𝐵𝑂𝑇 𝐹𝐼𝐿𝐸𝑆⬥(t.me/lllell4)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ِّّsource ᴄᴀɴᴄᴇʀ', url = 't.me/lllell0'}, 
},
}
...
if tonumber(data.message.sender.user_id) == tonumber(CNR) then
return false
end
Run(data.message,data.message)
elseif data and data.luatele and data.luatele == "updateMessageEdited" then
local Message_Edit = LuaTele.getMessage(data.chat_id, data.message_id)
if Message_Edit.sender.user_id == CNR then
return false
end
